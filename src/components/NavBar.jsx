    ...
    <>
      <div className='tw-hidden lg:tw-block tw-booking tw-bg-bone '>
        <div className='tw-grid tw-grid-cols-5'>
          <div className='tw-py-5 tw-pe-5' style={{ position: 'relative' }}> 
...
+66 63 193 3642
          ...
          <div className='tw-col-span-3'>
            <div className='tw-flex tw-ps-10 tw-space-x-10 tw-justify-evenly'>
              ...
              <div className='tw-py-5 d-flex'>
                  <div className='d-flex'>
                    <a href="https://www.facebook.com/Soulsmith.EmpathySauce" className='text-dark' >
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                  ...
                  <div className="ms-4 d-flex">
                    <a href="https://www.instagram.com/soulsmith_empathysauce" className='text-dark' >
      ...
      <nav className={navbarClasses} >
        <div className="container-fluid ">
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="#E8E5D7" class="bi bi-list" viewBox="0 0 16 16">
...
<a href="" className='tw-text-bone d-flex'>
