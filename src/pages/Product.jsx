...
import image437 from '../assets/products/mind-exercise-vol1/Image 437.jpg'
  ...
  return (
    <>
      <div className="container mt-4">
        <h2 className='text-center tw-text-gold tw-uppercase'><b>{t('Products')}</b></h2>
...
<div className="row ">
  <div className="col-12 col-lg-5 col-md-5 col-sm-12 mx-auto sections">
        <NavLink to={'/products/Mind-Magnifying'} className="text-decoration-none">
        <img src={image88} className="card-img-top" alt="..." />
    <div className="card-body product-card py-3 tw-bg-midnight">
      <h5 className="text-center px-3  tw-text-gold">{t('Mind Magnifying')}</h5>
  ...
  <div className="col-12 col-lg-5 col-md-5 col-sm-12 mx-auto sections">
        <NavLink to={'/products/Mind-Exercise-Vol1'} className="text-decoration-none">
        <img src={image437} className="card-img-top" alt="..." />
    <div className="card-body product-card py-3 tw-bg-midnight">
      <h5 className="text-center tw-text-gold px-3 ">{t('Mind Exercise Vol.1')}</h5>
