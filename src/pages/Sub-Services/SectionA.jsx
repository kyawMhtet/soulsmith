...
const SectionA = () => {
  ...
  return (
    <>
      <h2 className="tw-text-bone text-center mt-4">{t("SectionA")}</h2>

      <div className="container my-4">
        <p className="tw-text-bone">{t("ServiceDescription1")}</p>
      ...
      <div className="container text-center mt-4">
        <div className="row ">
          <div className="col-12 col-lg-4 col-md-12 col-sm-12 my-3">
            <NavLink
              to={
          ...
          {/* <div className="col-12 col-lg-4 col-md-2 col-sm-12 my-3 mx-auto">
