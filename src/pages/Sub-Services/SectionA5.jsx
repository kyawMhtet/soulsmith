            ...
            <div className=" about w-100">
              ...
              <ul className="mt-4 ms-lg-3">
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="p6Value">{t("A5aValue4")}</span>
                    </p>
                  ) : (
                    <p>
                      <span className="single">
                        <b className="">{t("A5aSession1")} </b>
                      </span>
                ...
                <li className="price">
                  ...
                  <span className="button">
                    <a
                      href="https://app.acuityscheduling.com/catalog.php?owner=29978531&category=%E0%B8%9A%E0%B8%A3%E0%B8%B4%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%81%E0%B8%B2%E0%B8%A3%E0%B8%AD%E0%B8%9A%E0%B8%A3%E0%B8%A1%E0%B9%80%E0%B8%8A%E0%B8%B4%E0%B8%87%E0%B8%9B%E0%B8%8F%E0%B8%B4%E0%B8%9A%E0%B8%B1%E0%B8%95%E0%B8%B4%E0%B8%AA%E0%B9%88%E0%B8%A7%E0%B8%99%E0%B8%95%E0%B8%B1%E0%B8%A7+-+Therapeutic+Workshop"
                      className="tw-text-bone tw-bg-gold button-1  tw-rounded-md"
                      target="_blank"
                    >
                      {t("BUY NOW")}
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="p6Value">{t("A5a1Value4")}</span>
                    </p>
                  ) : (
                    <p>
                      <span className="single">
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="tp12Value">{t("A5a1Value5")}</span>
                    </p>
                  ) : (
                    <p>
                      <span>
                      ...
                      <span className="p12Value">{t("A5a1Value5")}</span>
                    </p>
                  )}
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="tp13Value">{t("A5a1Value6")}</span>
                    </p>
                  ) : (
                    <p>
                      <span>
                      ...
                      <span className="p13Value">{t("A5a1Value6")}</span>
                    </p>
                  )}
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="p6Value">{t("A5bValue4")}</span>
                    </p>
                  ) : (
                    <p>
                      <span className="single">
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="p6Value">{t("A5b1Value4")}</span>
                    </p>
                  ) : (
                    <p>
                      <span className="single">
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="tp12Value">{t("A5b1Value5")}</span>
                    </p>
                  ) : (
                    <p>
                      <span>
                      ...
                      <span className="p12Value">{t("A5b1Value5")}</span>
                    </p>
                  )}
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <span className="tp13Value">{t("A5b1Value6")}</span>
                    </p>
                  ) : (
                    <p>
                      <span>
                      ...
                      <span className="p13Value">{t("A5b1Value6")}</span>
                    </p>
                  )}
