                ...
                <li className="price">
                  {isThaiLanguage ? (
                    ...
                    <p>
                      ...
                      <span className="">{t("A2aValue4")}</span>
                    </p>
                  )}
                ...
                <li className="price">
                  {isThaiLanguage ? (
                    <p>
                      ...
                      <small className="price7">
                        <b>:</b>
                      </small>
                      <span className="">{t("A2aValue6")}</span>
                    </p>
                  ) : (
                    <p>
                      <span>
